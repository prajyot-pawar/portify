...
import stylesectionproject from './ProjectPage.module.css';
...
<div className={stylesectionproject.line}></div>
       <div style= {pageContent} className={stylesectionproject.content}>
        <div className={styleproject.projectContent}>
